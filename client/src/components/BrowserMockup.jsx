...
// Screenshots ship as three widths (600/1000/native) generated by sharp from
// the source webp. Derives "/images/crf.webp" -> "/images/crf-600.webp" etc.
function srcSetFor(image) {
  const dot = image.lastIndexOf('.');
  const base = image.slice(0, dot);
  const ext = image.slice(dot);
  return `${base}-600${ext} 600w, ${base}-1000${ext} 1000w, ${image} 1400w`;
}
